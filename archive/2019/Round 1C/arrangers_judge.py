...
_ERROR_MSG_WRONG_ANSWER_FORMAT_STR = (
    "Wrong answer: contestant input {}, but answer is {}."
)
...
class JudgeSingleCase(object):
    ...
    def Judge(self):
        ...
        for i in range(self.max_inspection + 1):
            ...
            Output(self.figures[contestant_input - 1])
...
def JudgeAllCases(test_number, io):
    ...
    Output("{} {}".format(NUM_CASES, max_inspection))
